...
This project explores clustering galaxy populations from the IllustrisTNG cosmological simulation using unsupervised learning techniques. We focused on identifying meaningful groupings of galaxies based on their physical properties using Functional Data Analysis (FDA), Gaussian Mixture Models (GMM), and Hierarchical Clustering.
